        ...
        $sql1 = mysqli_query($con,"SELECT Id, Days_Swiped, First_Name, Last_Name FROM TDS");
         ...
         if ($date >= $sem1_start && $date <= $sem1_end){
                    ...
                    if($date > $sem1_reading){
                     ...
                     $sql6 = mysqli_query($con,"INSERT INTO Attendance (Attendance_Id, Att_Sem1, Swipes_Sem1, Classes_Sem1, Overall)
                     VALUES ('$stu_number', '$sem1_att', '$days_swiped', '$classes_total', '$sem1_att')");
                             ...
                             $classes_total = ($weeks*$class_week3)-$days_off3;
                   ...
                   if($month_start == $september){ 
                           ...
                           if(date > $sem2_reading){
                             ...
                             $classes_total = ($weeks*$class_week2)-$days_off2;                          
                     ...
                     $sql13 = mysqli_query($con,"INSERT INTO Attendance (Attendance_Id, Att_Sem1, Classes_Sem1, Swipes_Sem1, Overall)
                      VALUES ('$stu_number', '$sem1_att', '$classes_total', '$days_swiped', '$sem1_att')");
