<?php  
        ...
        $result = array();
         ...
         SELECT Student_Number, Course, Nationality, Gender
         FROM CRM
         WHERE Course = '$course_name'");
          
         while($row2 = mysqli_fetch_assoc($sql2)){
         
         $stu_number = $row2['Student_Number'];
         $course = $row2['Course'];
         ...
         $sql1 = mysqli_query($con,"SELECT Id, Days_Swiped, First_Name, Last_Name FROM TDS WHERE Id ='$stu_number'");
