        ...
        $sql1 = mysqli_query($con,"SELECT Id, Days_Swiped, First_Name, Last_Name FROM TDS");
         ...
         if ($date >= $sem1_start && $date <= $sem1_end){
                    ...
                    if($date > $sem1_reading){
                     ...
                     $sql6 = mysqli_query($con,"UPDATE Attendance SET Attendance_Id= '$stu_number', Att_Sem1 ='$sem1_att', 
                     Swipes_Sem1= '$days_swiped', Classes_Sem1='$classes_total', Overall='$sem1_att' WHERE Attendance_Id='$stu_number'");
                   ...
                   if($month_start == $september){ 
                     ...
                     $sql13 = mysqli_query($con,"UPDATE Attendance SET Attendance_Id='$stu_number', Att_Sem1='$sem1_att', 
                     Classes_Sem1='$classes_total', Swipes_Sem1='$days_swiped', Overall='$sem1_att' WHERE Attendance_Id ='$stu_number'");
