...
<head>
    ...
    body {
     ...
     <?php
        ...
        $query22 =  mysqli_query($con, "CREATE TABLE Temp(Id varchar(100), Overall int(100))");
   
        $query23 =mysqli_query($con,               
                      "INSERT INTO Temp SELECT CRM.Student_Number, Attendance.Overall FROM CRM JOIN Attendance ON Attendance.Attendance_Id = CRM.Student_Number WHERE CRM.Country ='$country'");           
    ?>
    ...
    function drawChart2() {
      ...
      var data = google.visualization.arrayToDataTable([
        ...
        $query22 = "SELECT COUNT(Id) AS Number FROM Temp WHERE Overall >= 80"; 
        $result22 = mysqli_query($con, $query22);        
         
        while($row22 = mysqli_fetch_array($result22)){  
         
        echo "['"."Above 80%"."',".$row22['Number']."],";
        }        
        ...
        $query6 = "SELECT COUNT(Id) AS Number FROM Temp WHERE Overall BETWEEN 70 AND 79"; 
        $result = mysqli_query($con, $query6);        
         
        while($row6 = mysqli_fetch_array($result)){  
         
        echo "['"."70% - 79%"."',".$row6['Number']."],";
        ...
        $query2 = "SELECT COUNT(Id) AS Number FROM Temp WHERE Overall BETWEEN 60 AND 69"; 
        ...
        $query3 = "SELECT COUNT(Id) AS Number FROM Temp WHERE Overall <= 50 "; 
      ...
      var options = {
        title: "STUDENTS ATTENDANCE for <?php echo $country?>",
        width: 600,
        height: 400,
        bar: {groupWidth: "95%"},
...
<body>
    ...
    <div class="row">
        ...
        <li><a href="country_graph.php?link=Brazil" name="Brazil">Brazil</a></li>
